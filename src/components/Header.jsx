...
import { Grid3X3, CreditCard, FlipHorizontal, Building2, Sun, Moon, ChevronDown } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="hidden sm:flex flex-col leading-tight">
            <span className="text-sm font-semibold tracking-tight text-foreground">ID Card Studio</span>
            <span className="text-[10px] text-muted-foreground font-medium tracking-wide uppercase">Pro — CR80 Standard</span>
          </div>
          {/* Mobile: shorter name */}
          <span className="sm:hidden text-sm font-semibold text-foreground">ID Card Studio</span>
        </div>
